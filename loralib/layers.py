...
class Linear(nn.Linear, LoRALayer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if r > 0:
            ...
            self.nd_lora_A = MatLoRA(maximum_rank=self.r)
            self.nd_lora_B = MatLoRA(maximum_rank=self.r)
    ...
    def set_rank(self, rank):
        self.nd_lora_A.set_rank(rank)
        self.nd_lora_B.set_rank(rank)
